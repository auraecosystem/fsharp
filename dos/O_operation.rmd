...
''
>_## This is commonly called the file extension.
...
Note File URIs are not portable across machines with different filesystem encodings.
...
Note Any OSError exceptions raised from scanning the filesystem are suppressed. This includes PermissionError when accessing directories without read permission.
